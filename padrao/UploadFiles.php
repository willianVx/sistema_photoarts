...
class UploadFiles
{
    ...
    private function moveFile()
    {
        ...
        $finalName = $this->config["folder"] . time();
        $pathAndName = $finalName . "." . $getFinalExtension[1];
        $this->config["finalPath"] = $pathAndName;
        $this->config["finalName"] = $finalName;
    ...
    {
        return $this->config["finalName"];
    }
    
    public function nameFinalFile()
    {
        return $this->config["finalPath"];    
    }
