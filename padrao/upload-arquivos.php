...
$variables = "<script type='text/javascript'>                       
                   ...
                   Selector.$('fileUpload').value = '" . $valor . "';
...
if (array_search($extensao, $_UP['extensoes']) === false) {
    $msgEx = '<font>Envie arquivos com a(s) seguinte(s) extenção(ões): .txt até 10Mb.</font>';
}
// Faz a verificação do tamanho do arquivo
else if ($_UP['tamanho'] < $_FILES['fileUpload']['size']) {
    $msgTa = '<font color="#ff0000">O arquivo enviado é muito grande, envie arquivos de até 10Mb.</font>';
}
// O arquivo passou em todas as verificações, hora de tentar movê-lo para a pasta
    ...
    if (move_uploaded_file($_FILES['fileUpload']['tmp_name'], $_UP['pasta'] . $nome_final)) {
        ...
        $msgOk = '<center><img src="imagens/success.gif" alt="Sucess" />&nbsp;&nbsp;
          <font color="green">Arquivo importado com sucesso!</font>
          </center>';
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <title>Importar Arquivos (Txt)</title>
    ...
    <body style="font-family: Arial;">
        <form method="post" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF']; ?>" name="upload" >
            ...
            <div id="conteudo" align="left">
                <br />
                <br />
                Arquivo:&nbsp;<input class="botao6" name="fileUpload" id="fileUpload" type="file" size="22"/>
                <br />
                <br />
                <div style="width: 300px; text-align: center">
                    <input type="submit" value="Enviar Arquivo" class="botao3" onclick="return Valida();"/><!--&nbsp;<input type="button" value="Sair" class="botao3" onclick="window.parent.location = '.index.html';"/>-->
                </div>
