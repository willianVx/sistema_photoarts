...
function PromptCadastrarClienteRapido(idCliente) {
    ...
    div.innerHTML += '<div id="div0" style="margin-top:0px; border-color:#D7D7D7; overflow:hidden" class="divformulario">' +
            ...
            '<div class="divcontainer" style="max-width: 250px;">' +
            '<label id="rotulocpf">CPF</label>' +
            '<input type="text" style="max-width:250px"  id="cpf" class="textbox_cinzafoco"/></div>' +
    ...
    dialogoCadastroClienteRapido = new caixaDialogo('PromptClientes', 520, 870, '../padrao/', 150);
