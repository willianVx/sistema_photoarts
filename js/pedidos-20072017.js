...
function CancelarAux(){
    ...
    if(alteracao){
        ...
        Selector.$('btcancel').innerHTML = 'CANCELAR';
        ...
        if (cor) {
         ...
         if (gridObras.getCellText(i, 27) == '' || gridObras.getCellText(i, 27).split('/')[gridObras.getCellText(i, 27).split('/').length - 1] == 'semarte.png') {
           ...
           // Selector.$('o_imagem2' + i).setAttribute("onclick", "verimagem('" + i + "','" + json[i].altura + "','" + json[i].largura + "');");
            ...
            Selector.$('o_imagem2' + i).setAttribute("onclick", 'MostraImagemTamanhoReal("imagens/obras/' + gridObras.getCellText(i,27) + '");');
        }
   ...
   // label.setAttribute('onclick', 'Selector.$("divCadastro").setAttribute("class", "divbranca"); dialogoCadastro.Close();');
    ...
    if (codigo >= 0) {  
        ...
        if (gridObras.getCellText(codigo, 12) == 1) {
            ...
            /*
            Select.Show(Selector.$('o_artista'), gridObras.getCellText(codigo, 13));
            getObrasArtista(false);
            Select.Show(Selector.$('o_obra'), gridObras.getCellText(codigo, 12));*/
...
function IncluirObra(linha) {
    ...
    if (photoArts) {
     ...
     var imgelemento = DOM.newElement('img');
        ...
        imgelemento.setAttribute("onclick", "MostraImagemTamanhoReal('imagens/instaarts/" + Selector.$('o_imagem').getAttribute('name') + "');");
...
function gerarOrdemProducao() {
    ...
    if (codigoAtual <= 0 || gridObrasProducao.getRowCount() <= 0) {
...
function PromptObrasRefazer() {
    ...
    if (!CheckPermissao(63, true, 'Você não possui permissão para gerar op refeita', false)) {
        return;
    }
