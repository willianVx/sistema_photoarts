...
window.onload = function () {
    ...
    Selector.$("legendaTela").innerHTML = "<div>Relatório de Orçamentos</div>";
    carregarmenu();
    getDadosUsuario();
...
function Lista() {
    ...
    var ajax = new Ajax('POST', 'php/relatorio-de-orcamentos.php', true);
    ...
    ajax.ajax.onreadystatechange = function () {
        ...
        for (var i = 0; i < json.length; i++) {
            ...
            ver.setAttribute('onclick', 'AbrirOrcamento(' + json[i].idOrcamento + ')');
            ...
            gridOrcamentos.getCell(gridOrcamentos.getRowCount() - 1, 4).setAttribute('style', 'text-align:left; width:380px;');
            gridOrcamentos.getCell(gridOrcamentos.getRowCount() - 1, 5).setAttribute('style', 'text-align:right; width:90px;');
            gridOrcamentos.getCell(gridOrcamentos.getRowCount() - 1, 6).setAttribute('style', 'text-align:right; width:90px;');
            gridOrcamentos.getCell(gridOrcamentos.getRowCount() - 1, 7).setAttribute('style', 'text-align:right; width:90px;');

            gridOrcamentos.getCell(gridOrcamentos.getRowCount() - 1, 8).setAttribute('style', 'text-align:left; width:120px;');

            gridOrcamentos.getCell(gridOrcamentos.getRowCount() - 1, 9).setAttribute('style', 'text-align:left; width:120px;');
            gridOrcamentos.getCell(gridOrcamentos.getRowCount() - 1, 10).setAttribute('style', 'text-align:center; width:100px;');
            gridOrcamentos.getCell(gridOrcamentos.getRowCount() - 1, 11).setAttribute('style', 'text-align:center; width:40px;');
        ...
        gridOrcamentos.addRow([
            ...
            DOM.newText(''),
            DOM.newText('Total'),
            DOM.newText(Number.FormatMoeda(gridOrcamentos.SumCol(5))),
            DOM.newText(Number.FormatMoeda(gridOrcamentos.SumCol(6))),
            DOM.newText(Number.FormatMoeda(gridOrcamentos.SumCol(7))),
            DOM.newText(''),
            DOM.newText(''),
            DOM.newText(''),
            DOM.newText('')
        ...
        gridOrcamentos.getCell(gridOrcamentos.getRowCount() - 1, 0).setAttribute('style', 'font-size:18px;text-align:center; width:50px');
        gridOrcamentos.getCell(gridOrcamentos.getRowCount() - 1, 1).setAttribute('style', 'font-size:18px;text-align:center; width:100px;');
        gridOrcamentos.getCell(gridOrcamentos.getRowCount() - 1, 2).setAttribute('style', 'font-size:18px;text-align:left; width:200px;');
        gridOrcamentos.getCell(gridOrcamentos.getRowCount() - 1, 3).setAttribute('style', 'font-size:18px;text-align:left;');
        gridOrcamentos.getCell(gridOrcamentos.getRowCount() - 1, 4).setAttribute('style', 'font-size:18px;text-align:left; width:380px;');
        gridOrcamentos.getCell(gridOrcamentos.getRowCount() - 1, 5).setAttribute('style', 'font-size:18px;text-align:right; width:90px;');
        gridOrcamentos.getCell(gridOrcamentos.getRowCount() - 1, 6).setAttribute('style', 'font-size:18px;text-align:right; width:90px;');
        gridOrcamentos.getCell(gridOrcamentos.getRowCount() - 1, 7).setAttribute('style', 'font-size:18px;text-align:right; width:90px;');
        gridOrcamentos.getCell(gridOrcamentos.getRowCount() - 1, 8).setAttribute('style', 'font-size:18px;text-align:center; width:120px;');
        gridOrcamentos.getCell(gridOrcamentos.getRowCount() - 1, 9).setAttribute('style', 'font-size:18px;text-align:left; width:120px;');
        gridOrcamentos.getCell(gridOrcamentos.getRowCount() - 1, 10).setAttribute('style', 'font-size:18px;text-align:center; width:100px;');
        gridOrcamentos.getCell(gridOrcamentos.getRowCount() - 1, 11).setAttribute('style', 'font-size:18px;text-align:center; width:40px;');
...
function AbrirOrcamento(idOrc) {
    ...
    window.location = 'propostas.html?idOrcamento=' + idOrc;
}
...
function botExportar_onClick() {
    ...
    var ajax = new Ajax('POST', 'php/relatorio-de-orcamentos.php', false);
...
function Imprimir_onClick() {
    ...
    window.open('impressao-de-relatorios.html?source=relatorio-de-orcamentos');
}
