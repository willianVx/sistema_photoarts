<?PHP
    ...
    html::div()->id("divmenu")->append(
        ...
        html::tag()->text('<!--divmenu-->')->appendTo($ToHtml);
        
        html::tag()->text('<!--pagina-->')->appendTo($ToHtml);

        html::div()->id("prompt")->appendTo($ToHtml);

        html::div()->id("divConfiguacoes")->class('divConfiguacoes efeito_delay')->style("height:0px;")->onclick("mostracaixaconfiguracoes();")->append(
        ...
        html::div()->id("divprincipal")->style("height:auto")->append(
            ...
            html::div()->align("center")->style("padding-left:5px;	margin-right:5px;")->append(
                ...
                html::div()->class("quadrosimples efeito_delay")->style(" clear:both; min-width:600px; width:95%; max-width:1000px; min-height:238px; display:block;")->align("left")->append(
                     ...
                     */
                    html::div()->class("divformulario")->id('divTabela')->style("min-height:750px; overflow: auto;")
                    
                )                
            
        )->appendTo( $ToHtml );
        
        html::tag()->text('<!--divprincipal-->')->appendTo( $ToHtml );
