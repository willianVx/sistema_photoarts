    ...
    if (mysql_num_rows($Tb) <= 0) {
        ...
        while ($linha = mysql_fetch_assoc($Tb)) {
            ...
            $json[] = array(
                ...
                'obras' => getObras($ArqT, $linha['idOrcamentoSimplificado'], ($linha['idTipoProduto']==1?'1':'0')),
...
function getObras($ArqT, $idOrcamentoSimplificado, $idArtista) {
    ...
    if (mysql_num_rows($Tb) <= 0) {
        ...
        return mysql_result($Tb, 0, "obras");
    }
}
    ...
    if ($idOrcamentoSimplificado <= 0 || $_POST['salvas'] == '0') {
        ...
        if ($_POST['item'] == '1') {
            ...
            $sql = "SELECT aot.idArtistaObraTamanho, t.idTamanho, t.nomeTamanho, aot.altura, aot.largura, aot.tiragemMaxima, 
                ...
                WHERE idArtistaObraTamanho=aot.idArtistaObraTamanho AND del=0) BETWEEN de AND ate) AS estrelas, 
        ...
        if($idObra == '0'){
            ...
            $sql = "SELECT oc.idOrcamentoComp, oc.idTamanho, t.nomeTamanho, oc.altura, oc.largura, oc.valor, 
                    ...
                    INNER JOIN tamanhos AS t ON t.idTamanho = oc.idTamanho 
                    INNER JOIN orcamentos_comp_instaarts AS oci ON oci.idOrcamentoComp = oc.idOrcamentoComp
                    WHERE oc.idOrcamento = " . $idOrcamentoSimplificado . " AND oc.idTipoProduto = 2 
            ...
            $sql = "SELECT osc.idOrcamentoComp, osc.idTamanho, t.nomeTamanho, osc.altura, osc.largura, 
                    ...
                    INNER JOIN artistas_obras_tamanhos AS aot ON aot.idArtistaObraTamanho = osc.idTamanho
                    INNER JOIN tamanhos AS t ON t.idTamanho = aot.idTamanho 
                    WHERE osc.idObra = " . $idObra . " AND osc.idOrcamento = " . $idOrcamentoSimplificado;
        ...
        $sql .= " AND osc.idOrcamento = " . $idOrcamentoSimplificado . " ";
...
function CalcularValorTamanhoInstaArts() {
    ...
    $sql = "SELECT precoBase, valorAcresMoldura
